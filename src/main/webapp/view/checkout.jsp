...
<body>
<div class="header">
  <a href="#default" class="logo">Checkout</a>
  <div class="header-right">
    <a href="shop.jsp">Home</a>
    <a class="active" href="#contact">Checkout</a>
  </div>
</div>
...
<div class="container">
	<table id="cart" class="table table-hover table-condensed">
					...
					<tfoot>
						...
						<tr>
							<td><a href="shop.jsp" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a></td>
