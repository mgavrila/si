...
<%@ page import="ro.ugal.si.dao.CartDaoImpl"%>
<%@ page import="java.util.List"%>
<%@ page import="ro.ugal.si.model.Cart"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="header">
		<a href="checkout.jsp" class="logo">Checkout</a>
		<div class="header-right">
			<a href="shop.jsp">Home</a> <a class="active" href="checkout.jsp">Checkout</a>
	...
	<div class="container">
		...
		<table id="cart" class="table table-hover table-condensed">
			...
			<tfoot>
				...
				<tr>
					<td><a href="shop.jsp" class="btn btn-warning"><i
